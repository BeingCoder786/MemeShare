...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img=(ImageView)findViewById(R.id.image);//get id by findview by
        b1=(Button)findViewById(R.id.share);
        b2=(Button)findViewById(R.id.next);
        mProgressBar=(ProgressBar)findViewById(R.id.progressBar);
        loadmeme();
       /* b1.setOnClickListener(new View.OnClickListener() {//first way to click on button.
            @Override
    ...
    public void sharememe(View view) {// get link of meme and share via whatsapp.
        Intent intent=new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.setType("text/plain");
        intent.putExtra(Intent.EXTRA_TEXT,"Hey, Checkout this Cool meme i got from Reddit \n"+ imageurl);
